...
const createBuild = (defaultAppConfig) => async (sourceDir = '.', commandOptions = {}) => {
    ...
    const cliAppConfig = resolveBuildAppConfig_1.resolveBuildAppConfig(sourceDir, commandOptions);
    // resolve user config file
    const userConfigPath = commandOptions.config
        ? config_1.resolveUserConfigPath(commandOptions.config)
        : config_1.resolveUserConfigConventionalPath(cliAppConfig.source);
