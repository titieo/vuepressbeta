import { Page, PageFrontmatter, App, HeadConfig, Plugin } from '@vuepress/core';
...
declare type ExtendPage<ExtendObject = Record<string, unknown>> = Page & {
    frontmatter: PageFrontmatter<BasePageFrontMatter>;
    git?: GitData;
} & ExtendObject;
interface PageSeoInfo<PageExtends = Record<string, unknown>> {
...
declare const seoPlugin: Plugin<SeoOptions>;

export default seoPlugin;
export { ArticleSeoContent, BaseSeoContent, ExtendPage, ExtendedSeoContent, FacebookSeoContent, PageSeoInfo, SeoContent, SeoOptions, SimpleSeoContent, TwitterSeoContent, seoPlugin };
